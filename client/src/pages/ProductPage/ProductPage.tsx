      ...
      {/* */}
       ...
       <div className="bg-white/50 rounded-2xl overflow-hidden">
        ...
        <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
         <img src={product.image} alt=""  className="max-h-[360px] w-auto object-contain"/>
       ...
       <div className="p-6 md:p-10 flex flex-col justify-center">
        ...
        <h1 className="text-2xl md:text-text-3xl font-semibold text-app-green mb-3">
         {product.name}
        </h1>
        ...
        {product.stock > 0 ? (
          ...
          <span className="text-sm of Stock">✅ Out of Stock</span>
        )}
        </div>
         ...
         <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
          ...
          <span className="px-5 text-sm font-semibold min-w-[40px] text-center">
           ...
           <button onClick={handlePlus} className="p-3 hover:bg-app-cream transition-colors">
            <PlusIcon className="w-g h-5"/>
          </button>
         </div> 

         <button onClick={() => {if(!inCart) addToCart(product, localQuantity)}} disabled={product.stock === 0}
         className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled:cursor-not-allowes active:scale-[0.98]
