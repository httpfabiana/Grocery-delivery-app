...
import { CreditCardIcon, MapPinIcon, CheckIcon, ArrowLeft, ChevronRightIcon } from "lucide-react";
       ...
       <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
         ...
         <button onClick={() => navigate("/products")} 
           className="px-5 py-2.5 bg-app-green text-white text-sm font-medium rounded-xl hover:bg-app-green-lighter transition-colors">
           Browse Products
         </button>
        </div>
       </div>
      ...
      <div className="min-h-screen bg-app-cream">
       <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <button onClick={() => navigate(-1)}
          ...
          >
          <ArrowLeft className="size04"/> Back
        </button>
           ...
           <div className="space-y-2 text-sm">
            <div className="flex  justify-between">
             ...
             <div className="flex  justify-between">
              ...
              <span>{deliveryFee === 0 ? <span>Free</span> : 
