  ...
  return (
   <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center">
     <img 
      ...
      <div className="absolute inset-0 bg-linear-tp-r from-app-green via-app-green/65 to-transparent"/>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
       <div className="max-w-xl xl:pl-10">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link to="/products" className="px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 trasnition-all border border-white/20">
            Browse Categories
          </Link>
        </div>
       </div>
