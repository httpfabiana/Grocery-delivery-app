import { ArrowUpRightIcon, BikeIcon, ChevronDownIcon, LogOut, MapPinIcon, MenuIcon, Package2Icon, SearchIcon, ShieldIcon, ShoppingCartIcon, UserIcon, XIcon } from "lucide-react";
...
const NavBar = () => {
   ...
   const user: any = {name: "Jonh Doe", email: "honh@example.com", isAdmin: true}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
       ...
       <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
        ...
        <div className="flex items-center gap-3">
         <button className="relative p-1 rounded-xl" onClick={() => setIsCartOpen(true)}>
                ...
                {user && 
                 ...
                 {user?.isAdmin && (
                  <Link to='/admin/products' className="dropdown-link">
                   <ShieldIcon className="text-app-orange-dark" size={18}/>
