      ...
      <div>
        ...
        <div className="flex items-center gap-2">
         <input
          ...
          placeholder="Min"
          value={minPrice}
          onChange={(e) => updateFilter('minPrince', e.target.value)}
         ...
         <span className="text-app-text-light">-</span>
          ...
          placeholder="Max"
          value={maxPrice}
          onChange={(e) => updateFilter('maxPrince', e.target.value)}
          className="w-full px-3 py-2 text-sm bg-white rounded-lg border not-focus:border-app-border"
         />
        </div>
      </div>
       ...
       {hasFilters && (
        <button className="w-full py-2 text-sm text-app-error hover:bg-red-50 rounded-lg transition-colors font-medium">
          Clear All Filters
        </button>
       )}
     </div>
