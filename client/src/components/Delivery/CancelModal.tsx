            ...
            <h3 className="text-lg font-semibold text-red-600 mb-2">
             ...
             <textarea 
              ...
              <div className="flex gap-2">
               <button onClick={() => { setCancelModal(null); setCancelReason(""); }} className="flex-1 py-2.5 text-sm font-medium text-zinc-600 bg-zinc-100 rounded-xl hover:bg-zinc-200 transition-colors">
                 Back
              </button>
